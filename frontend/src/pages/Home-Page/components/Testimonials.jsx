...
function Testimonials() {
  return (
    <section className="testimonial-section bg-blue-500/10 rounded-md py-12 sm:py-16 px-4 sm:px-6 mb-12">
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-2xl mx-auto px-2">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center leading-snug">
